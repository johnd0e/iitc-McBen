                    ...
                    if (justInts) {
                        ...
                        if (topObject.length >= 12 && topObject.length <= 18) {
                            ...
                            if (topObject[0] === 8) {
                                ...
                                if (decreasing) {
                                    console.info('int array '+topLevel+' looks like ZOOM_TO_LEVEL: '+JSON.stringify(topObject));
                            ...
                            if (topObject[topObject.length-1] >= 9000 && topObject[topObject.length-1] <= 64000) {
                                ...
                                if (increasing) {
                                    console.info('int array '+topLevel+' looks like TILES_PER_EDGE: '+JSON.stringify(topObject));
