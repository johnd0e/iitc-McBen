...
public class IITC_UserLocation implements CompassListener, LocationListener {
    ...
    private void updateListeners() {
        ...
        if (useLocation && !mLocationRegistered) {
            /*if (ContextCompat.checkSelfPermission(mIitc, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED &&
                    ContextCompat.checkSelfPermission(Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                // TODO: Consider calling Activity#requestPermissions to request the missing permissions, and then overriding
                //   public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults)
                // to handle the case where the user grants the permission. See the documentation for Activity#requestPermissions for more details.
                onStop();
                return;
            }*/
